...
export default class MainSideContractsReview extends Component {
  state = {
    currentIndex: -1,
  ...
  returnList() {
    if (localStorage.getItem("contractsReview") == null) {
      localStorage.setItem("contractsReview", JSON.stringify([]));
    }
    return JSON.parse(localStorage.getItem("contractsReview"));
  }
  ...
  handleDelete = (index) => {
    ...
    list.splice(index, 1);
    localStorage.setItem("contractsReview", JSON.stringify(list));
