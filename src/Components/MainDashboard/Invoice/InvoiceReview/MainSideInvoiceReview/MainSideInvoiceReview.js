...
import SubmitInvoiceReview from "./SubmitInvoiceReview/SubmitInvoiceReview";
import {NavLink} from "react-router-dom";

export default class MainSideInvoiceReview extends Component {
  render() {
    return (
