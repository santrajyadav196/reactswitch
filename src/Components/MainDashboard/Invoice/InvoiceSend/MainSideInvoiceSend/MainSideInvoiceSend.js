...
import SubmitInvoiveSend from "./SubmitInvoiveSend/SubmitInvoiveSend";

export default class MainSideInvoiceSend extends Component {
  render() {
    return (
        ...
        <div className='d-flex'>
          ...
          <div className='px-0 w-100'>
            <div className='p-5 mt-2'>
              <span className='DashMarg'>Invoices</span>
