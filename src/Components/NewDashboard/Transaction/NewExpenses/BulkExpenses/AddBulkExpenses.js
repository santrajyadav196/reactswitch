...
import coloredDownArrow from "../../../../../Assets/assetsnew/red-down-arrow.svg";

import "./AddBulkExpenses.css";

const AddBulkExpenses = (props) => {
      ...
      <>
        <div className='mt-3'>
          ...
          {/* <div className='row'>
            ...
            <div className='col col-md-6 col-sm-12'>
              <div className='mb-3'>
                <label htmlFor='stopOn' className='Form-Text'>
                  Stop On
                </label>
                <input
                  type='date'
...
export default AddBulkExpenses;
