...
import "./NavBarMainMobile.css";
import profile from "../../../Assets/Images/profile.png";
import digitalogyLogo from "../../../Assets/Images/digitalogyLogo.png";
import {FontAwesomeIcon} from "@fortawesome/react-fontawesome";
import {faTimes} from "@fortawesome/free-solid-svg-icons";

export default class NavBarMainMobile extends Component {
  render() {
    return (
      <Auxillary>
        <div
          className='Nav-top padding-NavBarMain-head'
        ...
        <NavLink
          className='d-flex side-main profileLink'
          style={{textDecoration: "none"}}
          to='/main/profile'
          onClick={this.props.close}>
          <div className='space-aroundProfile px-3'>
            <img src={profile} alt='profile' className='profileNav' />
          </div>
          <div className='profileView'>
            <span className='sideProfile'>Digitalogy</span>
            <span className='sideProfile px-3'>{">"}</span>
          </div>
        </NavLink>
        <ul className='Nav-mainMenu-mobile ul-reset-mobile'>
          <li className='link-mobile d-flex' onClick={this.props.close}>
            <NavLink
              className='d-flex side-main'
              ...
              <span className='Nav-link-mainmobile pt-2'>Dashboard</span>
            </NavLink>
          </li>
          <li className='link-mobile d-flex' onClick={this.props.close}>
            <NavLink
              ...
              <span className='Nav-link-mainmobile pt-2'>Clients</span>
            </NavLink>
          </li>
          <li className='link-mobile d-flex' onClick={this.props.close}>
            <NavLink
              ...
              <span className='Nav-link-mainmobile pt-2'>Projects</span>
            </NavLink>
          </li>
          <li className='link-mobile d-flex' onClick={this.props.close}>
            <NavLink
              ...
              <span className='Nav-link-mainmobile pt-2'>Invoices</span>
            </NavLink>
          </li>
          <li className='link-mobile d-flex' onClick={this.props.close}>
            <NavLink
              ...
              <span className='Nav-link-mainmobile pt-2'>Proposals</span>
            </NavLink>
          </li>
          <li className='link-mobile d-flex' onClick={this.props.close}>
            <NavLink
              ...
              <span className='Nav-link-mainmobile pt-2'>Contracts</span>
            </NavLink>
          </li>
          <li className='link-mobile d-flex' onClick={this.props.close}>
            <NavLink
              ...
              <span className='Nav-link-mainmobile pt-2'>Subscriptions</span>
            </NavLink>
          </li>
          <li className='link-mobile d-flex' onClick={this.props.close}>
            <NavLink
              ...
              <span className='Nav-link-mainmobile pt-2'>Time Tracking</span>
            </NavLink>
          </li>
          <li className='link-mobile d-flex' onClick={this.props.close}>
            <NavLink
              ...
              <span className='Nav-link-mainmobile pt-2'>Transactions</span>
            </NavLink>
          </li>
          <li className='link-mobile d-flex' onClick={this.props.close}>
            <NavLink
              ...
              <span className='Nav-link-mainmobile pt-2'>Statements</span>
            </NavLink>
          </li>
        </ul>
        <NavLink to='main/settings' className='settings'>
          <div className='space-aroundSetting px-4 py-2'>
          ...
          <span className='sideProfile fitMobile'>Settings</span>
        </NavLink>
      </Auxillary>
    );
  }
